...
const Textform = (props) => {
    ...
    return(
        ...
        <div className="container">
            ...
            <button className="btn btn-primary mx-1 my-1" onClick={Lowercase}>Convert to Lower-Case</button>
        ...
        <div className="container my-3">
            ...
            <p className={`text-${props.mode==='dark'?'light':'dark'}`}>Total Words is {text.split(' ').filter((element)=>{return element.length !==0}).length} and total character is {text.length}</p>
